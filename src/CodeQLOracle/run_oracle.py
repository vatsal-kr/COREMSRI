...
class LocalRunCodeQL:
    ...
    def __init__(self, exp_log_lib, codeql_pack_path):
        ...
        self.codeql_queries_dict: dict = {q["name"]: q["codeql_query"] for q in query_data}
    ...
    def run_codeql_single_query(
        ...
        # invoke bash script
        bash_script = "bash " + str(_FILE_DIR / RUN_CODEQL_SCRIPT_FILE_NAME) + " " + codeql_query + ' "' + folder_name + '" ' + exp_folder + " " + codeql_db_path + " " + codeql_result_path + " " + self.codeql_pack_path
